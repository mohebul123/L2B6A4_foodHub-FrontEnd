  ...
  return (
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed">
            Connecting local home chefs with food lovers. Experience the taste
            of authentic, healthy, and fresh home-cooked meals delivered to your
            door.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-slate-800 text-center text-xs">
        <p>
          © {new Date().getFullYear()} MealBridge Marketplace. All rights
          reserved.
        </p>
